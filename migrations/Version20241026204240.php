 ...
 */
final class Version20241026204240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `show` (numshow INT NOT NULL, theatre_play_id INT DEFAULT NULL, nbrseat INT NOT NULL, dateshow DATETIME NOT NULL, INDEX IDX_320ED901DAD2878B (theatre_play_id), PRIMARY KEY(numshow)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
